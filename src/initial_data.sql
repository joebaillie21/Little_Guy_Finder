INSERT INTO Little_Guys
    (name, info, friend_shaped, primary_trait, secondary_trait, tertiary_trait)
VALUES
    ('Brick', 'Just a lil brick guy. A little basic and boring but has a strong foundation and here to support. Stationary so no worries about exploring outside the home. Very cost effective.', FALSE, 11, 9, NULL),
    ('Raccoon', 'Just a lil trash panda. Likes to wash their hands and food before they eat. Can be a lil bit angry and jittery but can calm down once they get settled and used to their environment.', TRUE, 1, 7, NULL),
